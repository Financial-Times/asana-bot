...
class ReportGeneratorIntegrationSpec extends IntegrationSpec {
    ...
    private static final String optFields = "name,tags.name,due_on,notes,completed,subtasks.name,subtasks.completed,due_at,custom_fields,memberships.section.name"
